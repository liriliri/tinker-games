...
Play directly in [browser](https://tinker.liriliri.io/games/2048/), or install via TINKER: download from `https://tinker.liriliri.io/`, then run `npm i -g tinker-2048`.
